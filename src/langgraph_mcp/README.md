...
**Docker:** 
```bash
docker build -f src/langgraph_mcp/Dockerfile -t mcp-vibify-frontend .
docker run -p 8000:8000 mcp-vibify-frontend
```
...
Lastly, try to answer the questions at the bottom of 04_mcp_http_externalpackage.py.
--------------------------